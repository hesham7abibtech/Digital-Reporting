...
const BIMReviewEditorModal = dynamic(() => import('@/components/shared/BIMReviewEditorModal'), { ssr: false });
const BIMImportConfirmModal = dynamic(() => import('@/components/shared/BIMImportConfirmModal'), { ssr: false });
