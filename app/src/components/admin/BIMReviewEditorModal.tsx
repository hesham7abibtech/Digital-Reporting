          ...
          <form onSubmit={handleSubmit}>
            <div style={{ padding: '24px 32px', borderBottom: '1px solid var(--border)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: 'var(--section-bg)' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
                ...
                <div>
                  <h2 style={{ fontSize: 18, fontWeight: 800, margin: 0, color: 'var(--text-primary)' }}>{review ? 'EDIT BIM REVIEW RECORD' : 'INITIATE NEW BIM REVIEW'}</h2>
            ...
            <div style={{ padding: 40, display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: 40 }}>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                  ...
                  <div style={{ position: 'relative' }}>
                    ...
                    <input
                      ...
                      style={{ width: '100%', padding: '14px 16px 14px 44px', background: 'var(--section-bg)', border: '1px solid var(--border)', borderRadius: 14, color: 'var(--text-primary)', fontSize: 15, outline: 'none' }}
                    />
                  </div>
                </div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                  ...
                  <textarea
                    ...
                    style={{ width: '100%', padding: 16, background: 'var(--section-bg)', border: '1px solid var(--border)', borderRadius: 14, color: 'var(--text-primary)', fontSize: 14, outline: 'none', resize: 'none' }}
                  />
                </div>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                    ...
                    <div style={{ position: 'relative' }}>
                      ...
                      <input
                        ...
                        style={{ width: '100%', padding: '12px 14px 12px 40px', background: 'var(--section-bg)', border: '1px solid var(--border)', borderRadius: 12, color: 'var(--text-primary)', fontSize: 14, outline: 'none' }}
                      />
                    </div>
                  </div>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                    ...
                    <select
                      ...
                      style={{ width: '100%', padding: '12px 14px', background: 'var(--section-bg)', border: '1px solid var(--border)', borderRadius: 12, color: 'var(--text-primary)', fontSize: 14, outline: 'none' }}
                    >
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 20, padding: 32, background: 'var(--section-bg)', border: '1px solid var(--border)', borderRadius: 24 }}>
                <h3 style={{ fontSize: 13, fontWeight: 900, color: 'var(--teal)', textTransform: 'uppercase', letterSpacing: '0.2em', margin: 0, marginBottom: 4 }}>Review Metadata</h3>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                      ...
                      <input
                        ...
                        style={{ width: '100%', padding: '12px 14px', background: 'var(--section-bg)', border: '1px solid var(--border)', borderRadius: 10, color: 'var(--text-primary)', fontSize: 13, outline: 'none' }}
                      />
                    </div>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                    <label style={{ fontSize: 10, fontWeight: 800, color: 'var(--text-muted)', textTransform: 'uppercase' }}>InSite Review Output URL</label>
                    <div style={{ position: 'relative' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                      <label style={{ fontSize: 10, fontWeight: 800, color: 'var(--text-muted)', textTransform: 'uppercase' }}>On ACC</label>
                      <select
                ...
                <div style={{ marginTop: 'auto', display: 'flex', flexDirection: 'column', gap: 12 }}>
                  <button
                    ...
                    disabled={loading}
                    style={{
                      width: '100%', padding: '16px', background: 'var(--teal)', color: '#ffffff',
