...
export async function migrateBimReviews() {
  ...
  snapshot.docs.forEach(docSnap => {
    ...
    const migrated: any = {
      ...
      "Milestone Submissions": Array.isArray(data["Milestone Submissions"]) ? data["Milestone Submissions"] : (Array.isArray(data.milestoneSubmissions) ? data.milestoneSubmissions : (data.submissionDescription ? [data.submissionDescription] : [])),
      ...
      "ACC Review ID": data["ACC Review ID"] || data.reviewNumber || data.accReviewId || "",
      "InSite Review Status": data["InSite Review Status"] || data.insiteBimReviewStatus || "",
      "InSite Review Due Date": data["InSite Review Due Date"] || data.insiteReviewDueDate || null,
